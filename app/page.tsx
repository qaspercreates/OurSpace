  ...
  return (
    <main>
      <section className="hero container">
        {/* big logo only on landing */}
        <img src="/logo.svg" alt="OurSpace" className="hero-logo drop-shadow" />
        ...
        <p className="hero-sub">
          Anonymous posts. No sign-ups. X-style postcards with ❤️ likes, 👁 views and 🔗 share (shares a clean screenshot).
        </p>
      ...
      <section id="features" className="container pb-10 grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="card">
